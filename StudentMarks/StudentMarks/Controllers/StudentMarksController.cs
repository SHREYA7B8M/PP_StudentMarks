...
namespace StudentMarks.Controllers
{
    ...
    {
        private SchoolStatisticsEntities db = new SchoolStatisticsEntities();
        ...
        public ActionResult Create([Bind(Include = "StudentId,StudentName,Subject,Marks")] StudentMark studentMark)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "StudentId,StudentName,Subject,Marks")] StudentMark studentMark)
        {
            if (ModelState.IsValid)
            {
